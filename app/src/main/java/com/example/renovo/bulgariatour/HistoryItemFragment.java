...
import com.example.renovo.bulgariatour.adapters.HistoryRecyclerViewAdapter;
import com.example.renovo.bulgariatour.history.HistoryContent;
...
public class HistoryItemFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        historyContent = new HistoryContent(mContext);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_history_item_list, container,
                false);
        // Set the adapter
        if (view instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new HistoryRecyclerViewAdapter(HistoryContent.ITEMS));
        }
        return view;
    }
     ...
     */
    @SuppressWarnings("unused")
    public interface OnHistoryInteractionListener {void onHistoryInteractionListener();}
}
